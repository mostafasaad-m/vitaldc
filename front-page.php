...
<section class="relative min-h-screen flex flex-col justify-center overflow-hidden grid-mesh">
    <div class="relative z-10 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-32">
        ...
        <p class="font-body-lg text-on-surface-variant max-w-2xl mb-stack-lg">
            Stop being invisible to international buyers. We build your first professional gateway to global markets, taking you from zero online presence to a world-class digital brand.
        </p>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter max-w-3xl mb-stack-lg">
            <div class="p-6 glass-card border-t-2 border-t-export-yellow">
                <div class="text-export-yellow font-display-lg text-headline-lg mb-1">0 to 1</div>
                <div class="font-label-caps text-label-caps text-on-surface-variant">Digital Onboarding</div>
            </div>
            <div class="p-6 glass-card border-t-2 border-t-export-orange">
                ...
                <div class="font-label-caps text-label-caps text-on-surface-variant">Data Ownership</div>
            </div>
            <div class="p-6 glass-card border-t-2 border-t-export-yellow">
                <div class="text-export-yellow font-display-lg text-headline-lg mb-1">Global</div>
                <div class="font-label-caps text-label-caps text-on-surface-variant">Buyer Network</div>
            </div>
        </div>
        <div class="flex flex-wrap gap-4">
            <a class="bg-export-orange text-white px-8 py-4 font-label-caps text-label-caps font-bold transition-all hover:scale-[1.02] shadow-[0_0_20px_rgba(251,133,0,0.3)]" href="#">Go Digital Now</a>
    ...
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-2 gap-stack-lg items-center">
        <div>
            ...
            <p class="font-body-lg text-on-surface-variant mb-stack-lg max-w-md">
                International buyers verify partners online first. If you don't have a professional website, you don't have their trust. We bridge the gap between your quality products and a professional presence.
            </p>
            <div class="space-y-stack-md">
                <div class="flex gap-6 group">
                    ...
                    <div>
                        <h4 class="font-label-caps text-on-surface mb-1">Missed Opportunities</h4>
                        <p class="text-on-surface-variant text-body-md">Global buyers are searching for Egyptian products right now but finding your competitors instead.</p>
                    </div>
                </div>
                <div class="flex gap-6 group">
                    ...
                    <div>
                        <h4 class="font-label-caps text-on-surface mb-1">Trust Deficit</h4>
                        <p class="text-on-surface-variant text-body-md">A professional digital home is the modern prerequisite for international trade contracts.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="relative">
            ...
            <div class="absolute -bottom-10 -left-10 glass-card p-6 hidden md:block border-l-4 border-l-export-orange">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-label-caps text-label-sm text-on-surface-variant">CURRENT STATUS</div>
                        <div class="font-headline-md text-headline-md text-export-orange">INVISIBLE</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-section-gap relative bg-light-surface text-light-on-surface grid-mesh-light border-y border-light-border">
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="flex flex-col md:flex-row justify-between items-end mb-stack-lg gap-6">
            <div>
                <span class="font-label-caps text-export-orange text-label-caps tracking-[0.2em] uppercase mb-4 block">Your Launch Strategy</span>
                <h2 class="font-headline-lg text-headline-lg max-w-xl text-light-on-surface">THREE PHASES TO GLOBAL DOMINANCE</h2>
            </div>
            <div class="text-light-on-surface-variant font-label-caps text-label-sm border-l-2 border-export-yellow pl-6">
                TARGET: FROM_ZERO_TO_EXPORT
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-12 gap-gutter">
            <div class="md:col-span-8 group relative overflow-hidden bg-white p-8 border border-light-border transition-all hover:border-export-orange/30 hover:shadow-xl">
                <div class="flex justify-between items-start mb-12">
                    ...
                    <span class="font-label-caps text-light-on-surface-variant/20 text-headline-lg">PHASE 01</span>
                </div>
                <h3 class="font-headline-md text-headline-md mb-4">Professional Digital Home</h3>
                <p class="font-body-md text-light-on-surface-variant max-w-lg">We build your first world-class website optimized for international B2B conversion. Fast, secure, and designed to establish instant authority in your industry.</p>
                <div class="mt-8 opacity-0 group-hover:opacity-100 transition-opacity flex gap-4">
                    <span class="text-export-orange font-label-caps text-[10px]">#BESPOKE_DESIGN</span>
                    <span class="text-export-orange font-label-caps text-[10px]">#MOBILE_OPTIMIZED</span>
                    <span class="text-export-orange font-label-caps text-[10px]">#B2B_TRUST</span>
                </div>
            </div>
            <div class="md:col-span-4 bg-white p-8 border border-light-border transition-all hover:border-export-yellow/30 hover:shadow-xl">
                <div class="flex justify-between items-start mb-12">
                    ...
                    <span class="font-label-caps text-light-on-surface-variant/20 text-headline-lg">PHASE 02</span>
                </div>
                <h3 class="font-headline-md text-headline-md mb-4">Modern Marketing</h3>
                <p class="font-body-md text-light-on-surface-variant">Precision LinkedIn and Google Search campaigns that put your brand in front of high-intent buyers in the GCC, Europe, and beyond.</p>
            </div>
            <div class="md:col-span-12 bg-white p-8 border border-light-border transition-all hover:border-export-orange/30 hover:shadow-xl flex flex-col md:flex-row gap-8 items-center">
                <div class="flex-1">
                    <div class="flex justify-between items-start mb-12">
                        ...
                        <span class="font-label-caps text-light-on-surface-variant/20 text-headline-lg">PHASE 03</span>
                    </div>
                    <h3 class="font-headline-md text-headline-md mb-4">Automated Growth</h3>
                    <p class="font-body-md text-light-on-surface-variant">Smart AI layers that handle incoming inquiries, lead qualification, and CRM updates, so you can focus on shipping products.</p>
                </div>
                <div class="w-full md:w-80 h-48 bg-light-surface border border-light-border p-4 overflow-hidden relative">
                    <div class="font-label-caps text-[10px] text-export-orange mb-2">LAUNCH_SEQUENCE_ACTIVE</div>
                    <div class="space-y-1 font-label-caps text-[9px] text-light-on-surface-variant">
                        <div class="flex justify-between"><span>DESIGN_SYSTEM:</span> <span class="text-export-orange font-bold">READY</span></div>
                        <div class="flex justify-between"><span>DOMAIN_ACTIVATE:</span> <span class="text-export-orange font-bold">LIVE</span></div>
                        <div class="flex justify-between"><span>GOOGLE_INDEX:</span> <span class="text-export-orange font-bold">SUCCESS</span></div>
...
<section class="py-section-gap bg-surface-deep relative grid-mesh overflow-hidden">
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="mb-stack-lg border-l-4 border-export-yellow pl-8">
            ...
            <h2 class="font-display-lg text-headline-lg">THE PATH TO LAUNCH</h2>
            <p class="font-body-md text-on-surface-variant">Our proven roadmap from local manufacturing to global digital leadership.</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="p-6 glass-card border-l-2 border-l-export-yellow/30">
                ...
                <h4 class="font-label-caps text-on-surface mb-2">Discovery</h4>
                <p class="text-on-surface-variant text-label-sm">Analyzing your products and identifying high-demand global markets.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-orange/30">
                ...
                <h4 class="font-label-caps text-on-surface mb-2">Branding</h4>
                <p class="text-on-surface-variant text-label-sm">Crafting a digital identity that speaks to international standards.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-yellow/30">
                <div class="font-label-caps text-export-yellow text-headline-md mb-2">03</div>
                <h4 class="font-label-caps text-on-surface mb-2">Building</h4>
                <p class="text-on-surface-variant text-label-sm">Engineering your high-performance Global Launchpad.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-orange/30">
                <div class="font-label-caps text-export-orange text-headline-md mb-2">04</div>
                <h4 class="font-label-caps text-on-surface mb-2">Validation</h4>
                <p class="text-on-surface-variant text-label-sm">Rigorous testing for speed, security, and global accessibility.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-yellow/30">
                <div class="font-label-caps text-export-yellow text-headline-md mb-2">05</div>
                <h4 class="font-label-caps text-on-surface mb-2">Go-Live</h4>
                <p class="text-on-surface-variant text-label-sm">Deploying your presence to global edge servers for instant loading.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-orange/30">
                <div class="font-label-caps text-export-orange text-headline-md mb-2">06</div>
                <h4 class="font-label-caps text-on-surface mb-2">Marketing</h4>
                <p class="text-on-surface-variant text-label-sm">Activating digital ad funnels to attract B2B inquiries.</p>
            </div>
            <div class="p-6 glass-card border-l-2 border-l-export-yellow/30 col-span-1 lg:col-span-2 bg-export-orange/10">
                ...
                <h4 class="font-label-caps text-on-surface mb-2">Global Scale</h4>
                <p class="text-on-surface-variant text-label-sm">Expanding your reach and automating lead capture for 24/7 growth.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-section-gap bg-light-surface text-light-on-surface relative">
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
        <div class="flex flex-col md:flex-row gap-stack-lg items-center">
            <div class="flex-1">
                <span class="font-label-caps text-export-orange text-label-caps tracking-[0.2em] uppercase mb-4 block">Quality First</span>
                ...
                <p class="font-body-lg text-light-on-surface-variant mb-stack-md">
                    Even as your first website, we don't settle for templates. We build bespoke engines that grow with your business. No technical debt. No limitations. Just pure performance.
                </p>
                <ul class="space-y-4 mb-stack-lg">
                    <li class="flex items-center gap-3">
                        ...
                        <span class="font-body-md font-medium">99+ Google Lighthouse Speed Scores</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-export-orange" data-icon="verified">verified</span>
                        <span class="font-body-md font-medium">Enterprise-Grade Security Foundations</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <span class="material-symbols-outlined text-export-orange" data-icon="verified">verified</span>
                        <span class="font-body-md font-medium">100% Full Intellectual Property Rights</span>
                    </li>
                </ul>
            </div>
            <div class="flex-1 w-full bg-white border border-light-border p-8 shadow-2xl relative overflow-hidden">
                <div class="font-label-caps text-[11px] text-light-on-surface-variant/30 mb-4">SYSTEM_BENCHMARK_V1.0</div>
                <div class="space-y-6">
                    <div>
                        <div class="flex justify-between font-label-caps text-[10px] mb-2"><span>BASIC TEMPLATE</span> <span class="text-error">31/100</span></div>
                        <div class="h-2 bg-light-surface rounded-full overflow-hidden">
                            <div class="h-full bg-error w-[31%]"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between font-label-caps text-[10px] mb-2"><span>VITALDC GLOBAL ENGINE</span> <span class="text-export-orange font-bold">99/100</span></div>
                        <div class="h-2 bg-light-surface rounded-full overflow-hidden">
                ...
                <div class="mt-8 pt-8 border-t border-light-border text-center">
                    <p class="font-label-caps text-[12px] text-light-on-surface-variant italic">"A professional foundation is not a luxury; it's your entry ticket to global trade."</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-section-gap overflow-hidden relative bg-white text-light-on-surface border-t border-light-border">
    <div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10 text-center">
        ...
        <h2 class="font-display-lg text-display-lg mb-stack-md tracking-tighter text-light-on-surface">READY TO GO GLOBAL?</h2>
